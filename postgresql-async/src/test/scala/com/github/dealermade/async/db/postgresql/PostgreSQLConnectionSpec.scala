...
import com.github.dealermade.async.db.column.{DateEncoderDecoder, TimeEncoderDecoder, TimestampEncoderDecoder}
...
import com.github.dealermade.async.db.{Configuration, Connection, QueryResult}
...
class PostgreSQLConnectionSpec extends Specification with DatabaseTestHelper {
  ...
  final val sampleArray = Array[Byte](83, 97, 121, 32, 72, 101, 108, 108, 111, 32, 116, 111, 32, 77, 121, 32, 76, 105, 116, 116,
    108, 101, 32, 70, 114, 105, 101, 110, 100)
