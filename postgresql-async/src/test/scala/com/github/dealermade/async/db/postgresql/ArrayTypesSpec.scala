...
import com.github.dealermade.async.db.column.{TimestampWithTimezoneEncoderDecoder, InetAddressEncoderDecoder}
    ...
    "correctly parse the array type" in {
      ...
      withHandler { handler =>
        try {
          ...
          result(0)("text_column") === List("some,\"comma,separated,text",
