  ...
  "when processing bit columns" should {
    ...
    "result in binary data" in {
      ...
      withConnection { connection =>
        ...
        executePreparedStatement(connection, "INSERT INTO binary_test (some_bit) VALUES (B'0'),(B'1')")
    ...
    "result in binary data in BIT(2) column" in {
      ...
      withConnection { connection =>
        ...
        executeQuery(connection, create)
        executePreparedStatement(connection, "INSERT INTO binary_test (some_bit) VALUES (B'00'),(B'01'),(B'10'),(B'11')")
