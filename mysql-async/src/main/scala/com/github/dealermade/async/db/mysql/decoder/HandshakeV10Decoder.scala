...
import com.github.dealermade.async.db.mysql.message.server.{HandshakeMessage, ServerMessage}
...
class HandshakeV10Decoder(charset: Charset) extends MessageDecoder {
  ...
  import com.github.dealermade.async.db.mysql.decoder.HandshakeV10Decoder._
