...
import com.github.dealermade.async.db.mysql.message.client.{ClientMessage, HandshakeResponseMessage}
import com.github.dealermade.async.db.mysql.util.CharsetMapper
import com.github.dealermade.async.db.util.{ByteBufferUtils, Log}
...
class HandshakeResponseEncoder(charset: Charset, charsetMapper: CharsetMapper) extends MessageEncoder {
  ...
  import com.github.dealermade.async.db.mysql.encoder.HandshakeResponseEncoder._
  import com.github.dealermade.async.db.mysql.util.MySQLIO._
