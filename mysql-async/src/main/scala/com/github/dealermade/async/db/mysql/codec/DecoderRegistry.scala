...
import com.github.dealermade.async.db.mysql.binary.decoder._
import scala.annotation.switch
import com.github.dealermade.async.db.mysql.column._
import com.github.dealermade.async.db.mysql.util.CharsetMapper
import java.nio.charset.Charset
import com.github.dealermade.async.db.column._
import com.github.dealermade.async.db.column.{ByteDecoder => TextByteDecoder}
...
import com.github.dealermade.async.db.mysql.column.{TimeDecoder => TextTimeDecoder}
...
class DecoderRegistry(charset: Charset) {
  ...
  def textDecoderFor(columnType: Int, charsetCode: Int): ColumnDecoder = {
    (columnType: @switch) match {
      ...
      case ColumnTypes.FIELD_TYPE_DATETIME | ColumnTypes.FIELD_TYPE_TIMESTAMP => LocalDateTimeEncoderDecoder
