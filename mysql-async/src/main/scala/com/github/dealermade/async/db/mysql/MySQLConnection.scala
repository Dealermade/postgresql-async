...
import com.github.dealermade.async.db._
import com.github.dealermade.async.db.exceptions._
import com.github.dealermade.async.db.mysql.codec.{MySQLConnectionHandler, MySQLHandlerDelegate}
import com.github.dealermade.async.db.mysql.exceptions.MySQLException
import com.github.dealermade.async.db.mysql.message.client._
import com.github.dealermade.async.db.mysql.message.server._
...
class MySQLConnection(
  ...
  private final val connectionHandler =
    new MySQLConnectionHandler(configuration, charsetMapper, this, group, executionContext, connectionId)
