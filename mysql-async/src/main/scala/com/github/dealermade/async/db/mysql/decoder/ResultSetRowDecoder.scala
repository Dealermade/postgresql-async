...
import com.github.dealermade.async.db.mysql.message.server.{ResultSetRowMessage, ServerMessage}
...
class ResultSetRowDecoder(charset: Charset) extends MessageDecoder {
  ...
  import com.github.dealermade.async.db.mysql.decoder.ResultSetRowDecoder.NULL
