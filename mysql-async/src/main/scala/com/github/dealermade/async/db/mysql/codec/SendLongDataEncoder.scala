...
import com.github.dealermade.async.db.mysql.message.client.{ClientMessage, SendLongDataMessage}
...
class SendLongDataEncoder extends MessageToMessageEncoder[SendLongDataMessage](classOf[SendLongDataMessage]) {
  ...
  import com.github.dealermade.async.db.mysql.codec.SendLongDataEncoder.log
